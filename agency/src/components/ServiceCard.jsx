...
const ServiceCard = ({service,index}) => {
    ...
    const divRef = useRef(null) // we are used useRef to directly access the DOM element like div

    const handleMouseMove = (e)=>{

        const bound = divRef.current.getBoundingClientRect(); // this will give the position of the div
